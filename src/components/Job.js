...
const Job = ({item}) => { 
    ...
    return (
        <div className=' flex  w-343  small:w-396 small:container mx-auto bg-bgMobile mid:bg-white mb-2 h-52 mid:w-md  mid:h-40 py-4 px-4  rounded-md shadow-3xl '>
            <div className='flex absolute w-36 ml-44 small:ml-56 mid:ml-96'><span className='text-second text-sm mid:text-base inline mid:hidden'>Posted {findDate(item.created)} days ago</span></div>
